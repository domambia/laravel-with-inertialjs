        ...
        <section  class="bg-white p-8 rounded-xl max-w-md mx-auto border">
            <form @submit.prevent="submit" class="max-w-md mx-auto mt-8">
                ...
                <div class="mb-6">
                    ...
                    <input  v-model="form.name"  class="border p-2 w-full rounded" type="name" />
                ...
                <div class="mb-6">
                    <button
                        class="bg-blue-400 text-white-rounded py-2 px-4 hover:bg-blue-500 text-white"
                ...
                <div class="mt-3 text-center text-sm">
                    Already have an account?  <Link  class="text-blue-500" href="/auth/login"> Login </Link>
                </div>
            </form>
